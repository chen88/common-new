...
import {filterModule} from './filters/common-filter.index';
...
angular.module(tkgCommonModule, [
  ...
  .config(($qProvider, $sceProvider, $uibTooltipProvider, $httpProvider, $locationProvider, uibDatepickerConfig, uibDatepickerPopupConfig, toastrConfig) => {
  ...
  .run(($interpolate, $rootScope, $filter, $compile, $q, $http, $cookies, $timeout, $location, $interval, $uibModal, $parse, $templateCache, modalMessage, tkgConfig, modalPrompt, uibDateParser, toastr) => {
    _.extend(a, {
      $interpolate,
      $rootScope,
      $filter,
