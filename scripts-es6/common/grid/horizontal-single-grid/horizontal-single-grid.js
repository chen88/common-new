export function tkgHorizontalSingleGrid (tkgConfig) {
  return {
    restrict: 'E',
    template: require('./horizontal-single-grid.jade'),
...
export function tkgHorizontalSingleGridAddon (tkgConfig) {
  return {
    restrict: 'E',
    template: require('./horizontal-single-grid-add-on-panel.jade'),
    link: function ($scope, element, attrs) {
...
export function tkgHorizontalParallelGrid (tkgConfig) {
  return {
    restrict: 'E',
    template: require('./horizontal-parallel-grid.jade'),
    link: function ($scope, element, attrs) {
...
export function tkgHorizontalGrid (tkgConfig) {
  return {
    restrict: 'E',
    template: require('./horizontal-grid.jade'),
    link: function ($scope, element, attrs) {
