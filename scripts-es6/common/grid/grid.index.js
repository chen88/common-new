...
import * as singleGrid from './single-grid/single-grid';
...
angular.module(tkgGridModule, [])
  ...
  .directive('primaryBody', windowResize.primaryBody)
  .directive('primaryGrid', windowResize.primaryGrid)
  ...
  .directive('tkgSingleGrid', singleGrid.tkgSingleGrid)
  .directive('singleGrid', singleGrid.singleGrid)
  .directive('singleGridChildren', singleGrid.singleGridChildren)
  .directive('singleGridMinimizer', singleGrid.singleGridMinimizer)
  .directive('singleGridMaximizer', singleGrid.singleGridMaximizer)
